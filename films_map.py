...
def map_builder(lst, coordinates, year):
    '''
    Makes map.
    '''
    wrld_map = folium.Map()
    ...
    fg3 = folium.FeatureGroup(name='Total amount of the films ')
...
def main():
    ...
    map_builder(nearest_film_places, coordinates, year)
...
if __name__ == "__main__":
    ...
    # print(get_address_from_coordinates('51.5074, 0.1278'))
    # print(films_locations(2016, 'Ukraine'))
    main()
